...
class ParametricStatement extends PreparedStatementWrapper {
	 ...
	 */
	ParametricStatement(
			final Connection connection, final String sql, final boolean autoGeneratedKeys) throws SQLException {
		
		this.parser = new SQLParser(sql);
		if (autoGeneratedKeys) {
			this.setPreparedStatement(connection.prepareStatement(
					this.parser.getClause(), Statement.RETURN_GENERATED_KEYS
			));
		} else {
