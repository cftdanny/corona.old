 ...
 * @version $Id$
 */
public class MatchParamInjectParameterFactory implements InjectParameterFactory {
	...
	public InjectParameter create(
		...
		return new MatchParamInjectParameter(accessible, parameterType, annotations);
	}
}
