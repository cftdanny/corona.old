...
/**
 * <p>This factory is used to create {@link XmlRequestInjectProperty} for a property that is annotated 
 * with {@link JsonRequest}. </p>
 *
 * @author $Author$
 * @version $Id$
 */
public class XmlRequestInjectPropertyFactory implements InjectPropertyFactory {
	...
	public InjectProperty create(final ContextManagerFactory contextManagerFactory, final Method property) {
		return new XmlRequestInjectProperty(contextManagerFactory, property);
	}
}
