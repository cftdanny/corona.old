 ...
 * @version $Id$
 */
public class RC4CipherEngine implements CipherEngine {
	...
	public Key generateKey() throws CipherException {
		...
		try {
			...
			throw new CipherException("Fail to get key generator with RC4 algorithm", e);
		}
	...
	public void setEncryptKey(final byte[] key) throws CipherException {
		...
		try {
			...
			throw new CipherException("Fail to create and initialize RC4 cipher", e);
		}
	}
	...
	public void setDecryptKey(final byte[] key) throws CipherException {
		...
		try {
			...
			throw new CipherException("Fail to create and initialize decryption RC4 cipher", e);
		}
	}
	...
	public byte[] decrypt(final byte[] data) throws CipherException {
		...
		try {
			...
			throw new CipherException("Fail to decrypt data with RC4 cipher", e);
		}
	}
