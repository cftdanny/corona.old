...
/**
 * <p>The cipher to encrypt and decrypt data by Blowfish </p>
 *
 * @author $Author$
 * @version $Id$
 */
public class BlowfishCipherEngine implements CipherEngine {

	/**
	 * the encrypt and decrypt algorithm
	 */
	private static final String ALGORITHM = CipherEngineFactory.BLOWFISH;
	...
	public Key generateKey() throws CipherException {
		...
		try {
			...
			throw new CipherException("Fail to get key generator with Blowfish algorithm", e);
		}
	...
	public void setEncryptKey(final byte[] key) throws CipherException {
		...
		try {
			...
			throw new CipherException("Fail to create and initialize Blowfish cipher", e);
		}
	}
	...
	public void setDecryptKey(final byte[] key) throws CipherException {
		...
		try {
			...
			throw new CipherException("Fail to create and initialize decryption Blowfish cipher", e);
		}
	}
	...
	public byte[] decrypt(final byte[] data) throws CipherException {
		...
		try {
			...
			throw new CipherException("Fail to decrypt data with Blowfish cipher", e);
		}
	}
