...
/**
 * <p>This factory is used to create {@link InjectAnnotatedField} for a field that is annotated with 
 * {@link Inject}. </p>
 *
 * @author $Author$
 * @version $Id$
 */
public class InjectAnnotatedFieldFactory implements AnnotatedFieldFactory {
	...
	public AnnotatedField create(final ContextManagerFactory contextManagerFactory, final Field field) {
		return new InjectAnnotatedField(field);
	}
}
