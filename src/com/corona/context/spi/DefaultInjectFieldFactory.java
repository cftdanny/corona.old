...
/**
 * <p>This factory is used to create {@link DefaultInjectField} for a field that is annotated with 
 * {@link Inject}. </p>
 *
 * @author $Author$
 * @version $Id$
 */
public class DefaultInjectFieldFactory implements InjectFieldFactory {
	...
	public InjectField create(final ContextManagerFactory contextManagerFactory, final Field field) {
		return new DefaultInjectField(field);
	}
}
