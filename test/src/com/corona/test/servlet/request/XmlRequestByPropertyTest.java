 ...
 * @version $Id$
 */
public class XmlRequestByPropertyTest extends AbstractWebsiteTest {
	...
	@Test public void testJsonRequestByParam() throws Exception {
		...
		Marshaller<Address> marshaller = MarshallerFactory.get(JaxbMarshallerFactory.NAME).create(Address.class); 
