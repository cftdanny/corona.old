 ...
 * @version $Id$
 */
public class RC4CipherEngineTest {
	...
	@Test public void testEncryptAndDecrypt() throws Exception {
		...
		CertifiedKey key = CypherFactory.get(RC4CypherFactory.NAME).generateKey();
		Cypher cipher = CypherFactory.get(RC4CypherFactory.NAME).create(key);
