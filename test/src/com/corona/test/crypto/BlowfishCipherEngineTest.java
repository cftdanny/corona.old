...
import com.corona.crypto.BlowfishCypherFactory;
 ...
 * @version $Id$
 */
public class BlowfishCipherEngineTest {
	...
	@Test public void testEncryptAndDecrypt() throws Exception {
		...
		CertifiedKey key = CypherFactory.get(BlowfishCypherFactory.NAME).generateKey();
		Cypher cipher = CypherFactory.get(BlowfishCypherFactory.NAME).create(key);
